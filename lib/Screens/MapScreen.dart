...
//     final response = await http.get(Uri.parse('ws://172.20.10.2:8089'));
...
//   }
//
//   // http://192.168.1.228:5001/location
...
//         setState(() {
//           markers.removeWhere((marker) => marker.markerId.value == 'python');
//           markers.add(
//             Marker(
...
//   }
// }
// Future<LatLng> fetchPythonLocation() async {
//   final channel = await IOWebSocketChannel.connect('ws://172.20.10.2:8089');
//   final location = await channel.stream.first;
//   final decodedLocation = jsonDecode(location);
//   final latitude = decodedLocation['data']['latitude'];
//   final longitude = decodedLocation['data']['longitude'];
